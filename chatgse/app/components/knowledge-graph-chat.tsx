...
import GreenIcon from "../icons/green-circle.svg";
...
import styles from "./knowledge-graph-chat.module.scss";
...
function _Chat() {
  ...
  if (
    context.length === 0 &&
    session.messages.at(0)?.content !== KG_BOT_HELLO.content
  ) {
    const copiedHello = Object.assign({}, KG_BOT_HELLO);
    ...
    <div className={styles.chat} key={session.id}>
      <div className="window-header" data-tauri-drag-region>
        ...
        <div className={`window-header-title ${styles["chat-body-title"]}`}>
          ...
          >
            {!session.topic ? DEFAULT_KG_TOPIC : session.topic}
          </div>
